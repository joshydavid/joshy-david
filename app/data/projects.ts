...
export const projects: Project[] = [
  ...
  },
  {
    ...
    achievements: [
      "Developed a full-stack AI-powered web application using Java Spring Boot and Python, leveraging object-oriented design, builder pattern and MVC architecture from 0 to 1.",
      "Implemented token-bucket algorithm for rate limiting (50 requests per min) to prevent API overload.",
