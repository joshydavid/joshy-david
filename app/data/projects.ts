...
export const projects: Project[] = [
  ...
  },
  {
    ...
    achievements: [
      "Built a full-stack AI-powered web application using Java Spring Boot and Python, leveraging object-oriented design, builder pattern and MVC architecture from 0 to 1.",
      "Developed a custom Retrieval-Augmented Generation (RAG) pipeline combining semantic search with LLMs to generate contextually relevant answers.",
